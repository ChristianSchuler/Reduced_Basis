...
SubductionAngle1     =   50;     % Subduction angle slab 1
SubductionAngle2     =   30;     % Subduction angle slab 1
...
[Phase,Temp]        =   AddBox(Phase,Temp,Y,X,Z,BoxSides, 3, 'RotationPoint',RotPt, 'DipAngle', -SubductionAngle1,'TempType','Halfspace', 'topTemp',T_surf,'botTemp', T_mantle);          % mantle lithosphere

BoxSides            =   [p_y-lslab1 p_y p_x p_x+wslab2  -dcrusts 0];  % [Left Right Front Back Bottom Top] of the box
[Phase,Temp]        =   AddBox(Phase,Temp,Y,X,Z,BoxSides, 4, 'RotationPoint',RotPt, 'DipAngle', -SubductionAngle1,'TempType','Halfspace', 'topTemp',T_surf,'botTemp', T_mantle,'thermalAge',80);       	% crust (will override the slab phase above
...
[Phase,Temp]        =   AddBox(Phase,Temp,Y,X,Z,BoxSides, 3, 'RotationPoint',RotPt, 'DipAngle', SubductionAngle2,'TempType','Halfspace', 'topTemp',T_surf,'botTemp', T_mantle);          % mantle lithosphere

BoxSides            =   [p_y+d_y p_y+lslab2+d_y p_x p_x+wslab2  -dcrusts 0];  % [Left Right Front Back Bottom Top] of the box
[Phase,Temp]        =   AddBox(Phase,Temp,Y,X,Z,BoxSides, 4, 'RotationPoint',RotPt, 'DipAngle', SubductionAngle2,'TempType','Halfspace', 'topTemp',T_surf,'botTemp', T_mantle,'thermalAge',80);       	% crust (will override the slab phase above
